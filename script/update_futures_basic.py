...
class STOCKBASIC:  
    ...
    def get_futures_baseinfo(self):
        ...
        index_array = [ ('SCL9', '原油指数', 'YYZS', 30)
                       ,('SCL8', '原油主连', 'YYZL', 30)
                       ,('SC2012', '原油2012', 'YYELYE', 30)
                       ,('SC2101', '原油2101', 'YYEYLY', 30)
                       ,('SC2011', '原油2011', 'YYELYY', 30)
                       ,('AU2008', '黄金2008', 'HJELLB', 30)
                       ,('AU2009', '黄金2009', 'HJELLJ', 30)
                       ,('AU2007', '黄金2007', 'HJELLQ', 30)
                       ,('AG2007', '白银2007', 'BYELLQ', 30)
                       ,('AG2006', '白银2006', 'BYELLL', 30)
                       ,('RU2005', '橡胶2005', 'XJELLW', 30)
                       ,('I2009', '铁矿石2009', 'TKSELLJ', 29)
                       ,('I2008', '铁矿石2008', 'TKSELLB', 29)
